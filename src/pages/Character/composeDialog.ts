...
export function composeDialog (data: CharacterProfile) {
  ...
  // hair_color
  if(data.hair_color === 'none' || data.hair_color === 'n/a') str += 'no hair and'
  else {
  ...
  if(data.gender !== 'male' && data.gender !== 'female') str += `I guess, these aren't the Droids you're looking for.`
